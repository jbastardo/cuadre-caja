                    ...
                    {dayCuadres.length > 0 && (
                      <div className="space-y-0.5">
                        {dayCuadres.slice(0, 4).map(c => {
                          ...
                          const estado = calculateEstado(c);
                          const estadoShort = estado === "cuadrado" ? "✓" : estado === "descuadrado" ? "✗" : "△";
                            ...
                            <div
                              ...
                              className={`text-xs px-1 py-0.5 rounded truncate cursor-pointer hover:opacity-80 flex items-center gap-0.5
                                ${isNF ? "bg-purple-100 text-purple-800" :
                                  estado === "cuadrado"    ? "bg-green-100 text-green-800" :
                                  estado === "descuadrado" ? "bg-red-100 text-red-800" :
                                                              "bg-amber-100 text-amber-800"}`}
                            >
                              <span className={`font-bold ${estado === "cuadrado" ? "text-green-600" : estado === "descuadrado" ? "text-red-600" : "text-amber-600"}`}>{estadoShort}</span>
